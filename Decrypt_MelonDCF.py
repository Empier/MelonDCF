...
#filename="C:\\Users\\NHNEnt\\Downloads\\UnEGG\\jazz\\7apes-05-Cereal Keef.dcf"



path=""
path = "C:\\Users\\NHNEnt\\Desktop\\MyCode\\melonpy\\a\\"
file_list = os.listdir(path)
file_list_dcf = [file for file in file_list if file.endswith(".dcf")]

for i in range(0,len(file_list_dcf)):

    enc_file=open(path+file_list_dcf[i],"rb")
    dec_file=open(path+file_list_dcf[i]+".mp3","wb")

    filesize = os.path.getsize(path+file_list_dcf[i])
