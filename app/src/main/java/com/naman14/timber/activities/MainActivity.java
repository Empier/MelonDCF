...
import com.naman14.timber.filepickerdemo.Main2Activity;
...
public class MainActivity extends BaseActivity implements ATEActivityThemeCustomizer {
    ...
    /*
    public void jj(String path) {

        Context context =  getApplicationContext();

        // Intent intent = new Intent("my.action.name.is.test");
        //  MyReceiver receiver = new MyReceiver();
        // receiver.onReceive(context, intent);
        sendBroadcast(new Intent(Intent.ACTION_MEDIA_SCANNER_SCAN_FILE, Uri.parse("file://"+path+".mp3")));
        //   context.sendBroadcast(new Intent(Intent.ACTION_MEDIA_SCANNER_SCAN_FILE, Uri.parse("file://"+path+".mp3")));
    }
*/
    @Override
    public void onCreate(Bundle savedInstanceState) {
        ...
        //ccFilter.addAction("android.intent.action.cc");
        //ccFilter.addDataScheme("sampleasdf");
