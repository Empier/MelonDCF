...
import com.naman14.timber.filepicker.view.FilePickerDialog;
...
{   private FilePickerDialog dialog;
    ...
    {   super.onCreate(savedInstanceState);
        ...
        mFileListAdapter = new FileListAdapter(listItem, Main2Activity.this);
        fileList.setAdapter(mFileListAdapter);
        fileList.setLayoutManager(new LinearLayoutManager(Main2Activity.this));
        ...
        switch (requestCode) {
            case FilePickerDialog.EXTERNAL_READ_PERMISSION_GRANT: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(Main2Activity.this,"Permission is Required for getting list of files",Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
